...
name := "playq-foundation"
organization in ThisBuild := "net.playq.foundation"
defaultStubPackage in ThisBuild := Some("net.playq.foundation")
publishMavenStyle in ThisBuild := true
homepage in ThisBuild := Some(url("https://playq.net"))
licenses in ThisBuild := Seq("BSD-style" -> url("https://opensource.org/licenses/Apache-2.0"))
developers in ThisBuild := List(
  Developer(id = "playq", name = "PlayQ", url = url("https://github.com/PlayQ"), email = "support@playq.net"),
)
  ...
  .settings(
    paradoxMaterialTheme in Paradox ~= {
      _.withCopyright("7mind.io")
        .withRepository(uri("https://github.com/PlayQ/tg-foundation-backend-scala"))
